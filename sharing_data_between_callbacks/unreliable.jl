#=
Here's a sketch of an app with a callback that modifies data out of its scope.
This type of pattern will not work reliably for the reasons outlined in the
