...
Here's a simple example that binds five |Inputs| (the |value| property
of 2 |Dropdown| components, 2 |RadioItems| components, and 1 |Slider| component)
to 1 |Output| component (the figure property of the Graph component).
=#
using DataFrames,
    Dash, DashHtmlComponents, DashCoreComponents, PlotlyJS, UrlDownload
