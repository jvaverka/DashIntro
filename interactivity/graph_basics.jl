#=
The Graph component has four attributes that can change through user
interaction: |hoverData|, |clickData|, |selectedData|, and |relayoutData|.
These properties update when you hover over points, click on points, or
select regions in a graph.
=#
